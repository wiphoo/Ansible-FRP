...
# Run analysis
sonar-scanner \
    -Dsonar.projectKey=wiphoo:ansible-frp \
    ...
    -Dsonar.exclusions="**/__pycache__/**,**/htmlcov/**,**/.pytest_cache/**,**/.ruff_cache/**,**/.mypy_cache/**,**/*.pyc,**/*.pyo,**/*.pyd,**/*.tar.gz,**/collections/**,**/.ansible/**,**/.venv/**,**/.vscode/**,**/coverage.xml,**/.pre-commit-config.yaml,**/.yamllint,**/.ansible-lint,**/uv.lock,**/.nojekyll,**/*.md" \
